      ...
      <div className="footer-max-width max-content-container">
        <div className="footer-container">
          ...
          <span className="footer-text Content-Light">
            Our blood is 100% adrenaline!
          </span>
          <div className="footer-social-media">
            <span className="footer-text1">Follow us</span>
            <div className="footer-container1">
              <a
                href="https://www.linkedin.com/company/rayfoil-surf/"
                target="_blank"
              ...
              <a
                href="https://www.youtube.com/@rayfoil"
                target="_blank"
                rel="noreferrer noopener"
        ...
        <div className="footer-links">
          <div className="footer-container2">
            ...
            <Link to="/" className="footer-home footer-link">
              Home
            </Link>
            <Link to="/our-story" className="footer-our-story footer-link">
              Our Story
            </Link>
            <Link to="/product" className="footer-product footer-link">
              Product
            </Link>
            <Link to="/contact" className="footer-contact footer-link">
              Contact
            </Link>
          </div>
        </div>
