    ...
    <div className="our-story-container">
      ...
      <div className="our-story-stats">
        <div className="our-story-stat">
          ...
          <span className="our-story-text12">Have tested our foils</span>
        ...
        <div className="our-story-stat1">
          ...
          <span className="our-story-text15">Patents</span>
          <span className="our-story-text16">Patents pending</span>
          <h1 className="our-story-text17">3</h1>
        </div>
        <div className="our-story-stat2">
          ...
          <span className="our-story-text18">Locations</span>
          <span className="our-story-text19">Have our Rays been riden</span>
          <h1 className="our-story-text20">
            <span>20</span>
          </h1>
        </div>
      </div>
