...
const Home = (props) => {
  return (
    <div className="home-container">
      ...
      <Navbar image_src1="/playground_assets/kleeps%2023.01.2023-2.svg"></Navbar>
      <div className="home-hero">
        <span className="home-text">
          <span className="home-text01">Lorem ipsum dolor sit amet</span>
        </span>
        <h1 className="home-text02">Magnificent things are very simple</h1>
